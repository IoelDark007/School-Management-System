...
export function Sidebar() {
  ...
  const menuItems = [
    ...
    { icon: <Users size={20} />, label: "Staff", href: "/staff" },
    { icon: <School size={20} />, label: "Academics", href: "/academics/classes" },
    { icon: <Landmark size={20} />, label: "Finance", href: "/finance" },
    { icon: <Calendar size={20} />, label: "Attendance", href: "/attendance/staffAttendance" },
    { icon: <Calendar size={20} />, label: "Timetable", href: "/timetable"},
